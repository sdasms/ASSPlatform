...
namespace DB_WCF_IntegrateTest
{
    ...
    partial void InsertInstrumentStatus(InstrumentStatus instance);
    partial void UpdateInstrumentStatus(InstrumentStatus instance);
    partial void DeleteInstrumentStatus(InstrumentStatus instance);
    ...
    partial void DeleteStaff(Staff instance);
		...
		public FaultDataContext() : 
				base(global::DB_WCF_IntegrateTest.Properties.Settings.Default.AssDBConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<InstrumentStatus> InstrumentStatus
		{
			get
			{
				return this.GetTable<InstrumentStatus>();
			}
		}
	...
	public partial class CustomerReportFault : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _MappedFaultType;
    ...
    partial void OnMappedFaultTypeChanging(System.Nullable<int> value);
    ...
    partial void OnProjectNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ProjectID", DbType="NChar(10)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MappedFaultType", DbType="Int")]
		public System.Nullable<int> MappedFaultType
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FaultType_CustomerReportFault", Storage="_FaultType", ThisKey="MappedFaultType", OtherKey="ID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._FaultType.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._MappedFaultType = value.ID;
					}
					else
					{
						this._MappedFaultType = default(Nullable<int>);
					}
    ...
    partial void OnIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FaultType_CustomerReportFault", Storage="_CustomerReportFault", ThisKey="ID", OtherKey="MappedFaultType")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FaultType_FixEvent", Storage="_FixEvent", ThisKey="ID", OtherKey="FaultType")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="InstrumentType_FaultType", Storage="_InstrumentType1", ThisKey="InstrumentType", OtherKey="ID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._InstrumentType1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.FaultType.Remove(this);
					}
					this._InstrumentType1.Entity = value;
					if ((value != null))
					{
						value.FaultType.Add(this);
    ...
    partial void OnFaultTypeChanging(int value);
    partial void OnFaultTypeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FaultType", DbType="Int NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FaultType_FixEvent", Storage="_FaultType1", ThisKey="FaultType", OtherKey="ID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._FaultType1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._FaultType = value.ID;
					}
					else
					{
						this._FaultType = default(int);
					}
	...
	public partial class Instrument : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<InstrumentStatus> _InstrumentStatus;
    ...
    partial void OnRemarksChanged();
		...
		public Instrument()
		{
			...
			this._InstrumentStatus = default(EntityRef<InstrumentStatus>);
		...
		public int CurrentStatusID
		{
			...
			set
			{
				...
				{
					if (this._InstrumentStatus.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="InstrumentStatus_Instrument", Storage="_InstrumentStatus", ThisKey="CurrentStatusID", OtherKey="ID", IsForeignKey=true)]
		public InstrumentStatus InstrumentStatus
		{
			get
			{
				return this._InstrumentStatus.Entity;
			}
			set
			{
				InstrumentStatus previousValue = this._InstrumentStatus.Entity;
				if (((previousValue != value) 
							|| (this._InstrumentStatus.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._InstrumentStatus.Entity = null;
						previousValue.Instrument.Remove(this);
					}
					this._InstrumentStatus.Entity = value;
					if ((value != null))
					{
						value.Instrument.Add(this);
					...
					this.SendPropertyChanged("InstrumentStatus");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.InstrumentStatus")]
	public partial class InstrumentStatus : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="InstrumentStatus_Instrument", Storage="_Instrument", ThisKey="ID", OtherKey="CurrentStatusID")]
		public EntitySet<Instrument> Instrument
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="InstrumentStatus_InstrumentStatusHistory", Storage="_InstrumentStatusHistory", ThisKey="ID", OtherKey="StatusID")]
		public EntitySet<InstrumentStatusHistory> InstrumentStatusHistory
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.InstrumentStatus = this;
		}
		
		private void detach_Instrument(Instrument entity)
		{
			this.SendPropertyChanging();
			entity.InstrumentStatus = null;
		}
    ...
    partial void OnIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="InstrumentStatus_InstrumentStatusHistory", Storage="_InstrumentStatus", ThisKey="StatusID", OtherKey="ID", IsForeignKey=true)]
		public InstrumentStatus InstrumentStatus
		{
			get
			{
	...
	public partial class InstrumentType : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<FaultType> _FaultType;
    ...
    partial void OnIDChanged();
		...
		{
			this._FaultType = new EntitySet<FaultType>(new Action<FaultType>(this.attach_FaultType), new Action<FaultType>(this.detach_FaultType));
			this._FixEvent = new EntitySet<FixEvent>(new Action<FixEvent>(this.attach_FixEvent), new Action<FixEvent>(this.detach_FixEvent));
			this._Instrument = new EntitySet<Instrument>(new Action<Instrument>(this.attach_Instrument), new Action<Instrument>(this.detach_Instrument));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="InstrumentType_FaultType", Storage="_FaultType", ThisKey="ID", OtherKey="InstrumentType")]
		public EntitySet<FaultType> FaultType
		{
			get
			{
				return this._FaultType;
		...
		private void attach_FaultType(FaultType entity)
		{
			this.SendPropertyChanging();
			entity.InstrumentType1 = this;
		}
		
		private void detach_FaultType(FaultType entity)
		{
			this.SendPropertyChanging();
